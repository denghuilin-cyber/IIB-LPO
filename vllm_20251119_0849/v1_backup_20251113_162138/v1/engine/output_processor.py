...
class RequestState:
    ...
    def _new_completion_output(
        ...
        # 🆕 Prepare entropies, based on delta mode
        entropies = self.entropies.copy() if self.entropies else None
        if delta and entropies:
    ...
    def process_outputs(
        ...
        **********************************************************
        ...
        for engine_core_output in engine_core_outputs:
            ...
            # 🆕 3.5) Update entropies for request, if available.
            if engine_core_output.new_entropies:
                req_state.entropies.extend(engine_core_output.new_entropies)
