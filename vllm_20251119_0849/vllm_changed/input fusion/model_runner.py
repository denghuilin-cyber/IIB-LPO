...
class GPUModelRunnerBase(ModelRunnerBase[TModelInputForGPU]):
    ...
    def __init__(
        ...
        # 🆕 I²B-LPO: Z injection config for CVAE branching
        self.z_injection_config: Optional[Any] = None
        ...
        with self.attn_state.graph_capture(max_batch_size), graph_capture(
            ...
            for virtual_engine in range(
                ...
                for batch_size in cudagraph_capture_sizes:
                    ...
                    # 🆕 I²B-LPO: CUDA graph capture 时不传入 z_injection_config（None）
                    with set_forward_context(attn_metadata, self.vllm_config,
                                             virtual_engine,
                                             z_injection_config=None):
    ...
    def execute_model(
        ...
        **kwargs,
        ...
        if not bypass_model_exec:
            # 🆕 I²B-LPO: 传入 z_injection_config 到 ForwardContext
