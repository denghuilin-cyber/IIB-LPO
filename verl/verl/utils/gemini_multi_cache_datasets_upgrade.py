...
def run_training(args, device, rank, world_size, dataset_names, combined_dataset_name_str):
    ...
    embedding_model = AutoModel.from_pretrained(args.embedding_model_path).to(device); embedding_model.eval(); tokenizer = AutoTokenizer.from_pretrained(args.embedding_model_path, use_fast=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--latent_dim", type=int, default=128, help="潜藏技能空间的维度")
