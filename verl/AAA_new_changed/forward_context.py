...
class ZInjectionConfig:
    ...
    """
    mode: Optional[str] = None  # "input", "psa", "softmax", "random"
    z_proj_vocab: Optional[torch.Tensor] = None  # For SOFTMAX mode: [vocab_size]
    z_proj_hidden: Optional[torch.Tensor] = None  # For INPUT/PSA mode: [1, hidden_size]
    injection_layers: Optional[list[int]] = None  # For PSA mode: which layers to inject
