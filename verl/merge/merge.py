...
if __name__ == '__main__':
    # step = 200
    # local_dir = f"/mindopt/nlp_data/longli/Dynamic_Verl/checkpoints/verl/MATH-Qwen2.5-Math-7B-GRPO-deepmath-gamma1-replace-wrong/global_step_{step}/actor" 
    # hf_path = f"/mindopt/NSR/models/Qwen2.5-Math-7B" 
    # output_path = f"/mindopt/nlp_data/longli/Dynamic_Verl/models/verl/MATH-Qwen2.5-Math-7B-GRPO-deepmath-gamma1-replace-wrong" 

    parser = argparse.ArgumentParser(description="Test Argument Parser")
    parser.add_argument('--model_name', type=str, default='test_model')
    parser.add_argument('--step', type=int, default=200)
    parser.add_argument('--hf_path', type=str, default='models/Qwen2.5-Math-7B')
    ...
    local_dir = os.path.join(model_name,f"global_step_{step}","actor")
    output_path =  os.path.join(model_name,f"global_step_{step}","merged")
