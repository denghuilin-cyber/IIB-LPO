...
ENTROPY_SAVE_INTERVAL=2       # 🔥 每 1 个 step 保存一次（调试用）
...
python3 -m verl.trainer.main_ppo \
  ...
  actor_rollout_ref.rollout.cvae_model_path="/nas/dhl/CVAE/models/GSM8K-MATH-trained/lars_selector_GSM8K-MATH.pth" \
  actor_rollout_ref.rollout.cvae_embedding_model_path="/nas/dhl/CVAE/models/deberta-v2-xlarge" \
