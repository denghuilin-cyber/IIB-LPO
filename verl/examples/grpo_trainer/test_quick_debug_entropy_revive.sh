...
TENSOR_PARALLEL=1
N_ROLLOUTS=2  # 🔥 只生成 1 个 rollout
BATCH_SIZE=2  # ⚠️ 真实训练 batch size 需 ≥ 最小值 8
...
CVAE_BRANCHING_MODE="random"  # 分叉模式: random, input, psa, softmax
...
#mkdir -p "${OUTPUT_DIR}"
OUTPUT_DIR=/nas/dhl/outputs/quick_debug_entropy_random_3_4_20251117_102546
...
python3 -m verl.trainer.main_ppo \
  ...
  +trainer.load_checkpoint_path="/nas/dhl/outputs/quick_debug_entropy_random_3_4_20251117_102546/global_step_2700" 2>&1 | tee ${LOG_FILE}
